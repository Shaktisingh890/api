...
return [
    ...
    [
        'match' => [
            'prefixes' => ['api/v1/*'], // your actual route group prefix
            'domains' => ['*'], // optional, but usually safe to leave as '*'
        ],
        'include' => [], // manually include specific routes (optional)
        'exclude' => [], // manually exclude specific routes (optional)
    ],
],
